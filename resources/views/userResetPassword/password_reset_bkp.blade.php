...
<body style="background: linear-gradient(to bottom right, #62BB46FF, #000000, #000000);">
  <div class="container">
    <div class="row">
      <div class="card" style="width: 40rem; margin: 50px auto;">
        <div class="card-header" style="background:linear-gradient(62deg, rgba(0, 5, 0, 1) 0%, rgba(33, 123, 24, 1) 100%); text-align: center;">
          <img src="{{ URL::asset('images/logo.png') }}" style="width: 50%;" />
        </div>
        <div class="card-boady">

          <div class="col-md-12" style="margin: 15px 0;">
          <form id="reset_password_form" action="{{ route('update_password') }}" method="POST" onsubmit="return checkPassword();">
            @csrf
            ...
            <!-- </div> -->
              ...
              <!-- <a id="submit_form" type="submit" class="btn" style="background: #3fa21f; color: #fff;">Submit</a> -->
  ...
  // $("#reset_password_form1").submit(function(event){
