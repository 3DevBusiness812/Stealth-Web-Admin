...
{!! Form::open( array('id' => 'editformNormaluser','class' => 'form', 'method' => 'post')) !!}
       ...
       <div class="page-wrapper">
           <div class="row user-content">
               ...
               <input type="hidden" name="userfullname" value="{{isset($users->firstname) ? $users->firstname:''}} {{isset($users->lastname)?$users->lastname:''}}"/>
               <div class="col-lg-4">
              ...
              <h3><span>Add Premium</span></h3></div>
              <div class="user-detail col-12" id="userexpiryDiv" style="display:none;">
              <div class="row" id="no_expDiv">
              <p class="w-100">Expiration Date</p> 
               
              <div class="date-form">
                <span class="fa fa-calendar calendar-input"></span>
                <input type="text" class="form-control datepicker" id="expiryDate_normal" name="expiryDate_normal"  value="{{isset($users->expiry) ? $users->expiry:''}}"  readonly>
               </div>
                </div>
                <div class="row mt-4">
                <div class="pretty p-svg p-curve checkbox">
                            <input type="checkbox" class="premium_month" name ="expiry_month" value="1"/>
                            <div class="state p-success">
                                <!-- svg path -->
                                <svg class="svg svg-icon" viewBox="0 0 20 20">
                                    <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z" style="stroke: white;fill:white;"></path>
                ...
                <div class="pretty p-svg p-curve checkbox">
                            <input type="checkbox" class="premium_month" name ="expiry_month" value="3"/>
                            <div class="state p-success">
                                <!-- svg path -->
                                <svg class="svg svg-icon" viewBox="0 0 20 20">
                                    <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z" style="stroke: white;fill:white;"></path>
                ...
                <div class="pretty p-svg p-curve checkbox">
                            <input type="checkbox" class="premium_month" name ="expiry_month" value="6"/>
                            <div class="state p-success">
                                <!-- svg path -->
                                <svg class="svg svg-icon" viewBox="0 0 20 20">
                                    <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z" style="stroke: white;fill:white;"></path>
                ...
                <div class="pretty p-svg p-curve checkbox">
                            <input type="checkbox" class="premium_month" name="expiry_month" value="50"/>
                            <div class="state p-success">
                                <!-- svg path -->
                                <svg class="svg svg-icon" viewBox="0 0 20 20">
                                    <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z" style="stroke: white;fill:white;"></path>
        ...
        <button  type="submit" class="btn float-right btn-green-bottom" id="normal-save-btn">SAVE</button>
        @if($page == 'all')
        ...
        @else
        <button  type="button" class="btn float-right btn-grey-bottom" onclick="window.location.href = '{{ url('admin/normalUsersList') }}';">CANCEL</button>
        @endif
        {!! Form::close() !!}
