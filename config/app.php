...
return [
    ...
    */
    ...
    'video_folder'=>'videos/',
    's3_video_folder'=>'https://stealthgo.s3.us-west-2.amazonaws.com/videos/',
    'sns_access_key_id' => env('SNS_ACCESS_KEY_ID'),
    'sns_secret_access_key' => env('SNS_SECRET_ACCESS_KEY'),
    'sns_default_region' => env('SNS_DEFAULT_REGION'),

    'sns_apns_arn' => env('SNS_APNS_ARN'),
    'sns_gcm_arn' => env('SNS_GCM_ARN'),
